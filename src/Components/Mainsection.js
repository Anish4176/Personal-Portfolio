...
function Mainsection() {
    return (
        ...
        <div id='home' className="bg-hero-pattern bg-no-repeat bg-cover bg-left pt-[11rem] md:pt-1  flex-row lg:flex justify-center items-center min-h-screen xl:justify-start">
