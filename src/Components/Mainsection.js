...
function Mainsection() {
    return (
        ...
        <div id='home' className="bg-hero-pattern container-snap  bg-no-repeat bg-cover bg-left pt-[12rem] md:pt-1  flex-row lg:flex justify-center  items-center min-h-screen xl:justify-start">
