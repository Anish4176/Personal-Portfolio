...
const Projects = () => {
   return (
      <div className=" flex-row space-y-4">
         ...
         {/* All projects  */}
         <div className="card-container flex flex-wrap space-y-4 py-1 font-roboto justify-center items-center">
            <div></div>
            <div className="border-2 border-gray-600 max-w-md font-roboto bg-slate-200 hover:bg-slate-300 rounded-md  p-5 flex-row mx-3">
               {/* PROJECT-1  */}
               <img src={Project1} alt="project1" />
               <h1 className='  text-3xl px-3 mt-8 font-bold '>Notehub-Your notes on the Cloud</h1>
            ...
            <div className="border-2 border-gray-600 max-w-md bg-slate-200 hover:bg-slate-300 rounded-md  p-5 flex-row mx-3">
               ...
               <h1 className='  text-3xl px-3 mt-8 font-bold '>Weather Website</h1>
            ...
            <div className="border-2 border-gray-600  max-w-md bg-slate-200 hover:bg-slate-300 rounded-md  p-5 flex-row mx-3">
               ...
               <h1 className='  text-3xl px-3 mt-8 font-bold '>To-Do List</h1>
